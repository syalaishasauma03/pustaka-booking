...
class Laporan extends CI_Controller {
 ...
 and p.no_pinjam=d.no_pinjam")->result_array();
            ...
            $this->load->view('templates/topbar', $data);
            $this->load->view('templates/laporan-pinjam', $data);
    ...
    {
        $data = array( 'title' => 'Laporan Data Peminjam Buku', 'laporan' => $this->db->query("select * from pinjam p, detail_pinjam d, buku b, user u where d.id_buku=b.id and p.id_user=u.id and p.no_pinjam=d.no_pinjam")->result_array());
