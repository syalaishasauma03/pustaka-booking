    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="#" class="btn btn-primary mb-3" data-toggle="modal" data-target="#bukuBaruModal">
                <i class="fas fa-file-alt"></i> Tambah Buku
            </a>
                    ...
                    <?php
                        ...
                        foreach ($buku as $b) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('buku/ubahBuku/') . $b['id']; ?>" class="badge badge-info"><i class="fas fa-edit"></i> Change</a>
                                    <a href="<?= base_url('buku/hapusBuku/') . $b['id']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul.' '.$b['judul_buku']; ?> ?')" class="badge badge-danger"><i class="fas fa-trash"></i> Delete</a>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bukuBaruModal">Add Book</h5>
